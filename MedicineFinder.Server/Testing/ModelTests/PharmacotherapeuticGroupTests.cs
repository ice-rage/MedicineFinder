...
{
    /// <summary>
    /// Класс, содержащий модульные тесты для класса <see cref="PharmacotherapeuticGroupTests"/>.
    /// </summary>
    [TestFixture]
    public class PharmacotherapeuticGroupTests
    {
        ...
        /// </summary>
        private readonly PharmacotherapeuticGroup _testPharmacotherapeuticGroup = new()
        {
