...
namespace MedicineFinder.Server.Testing.ModelTests
{
    ...
    public class ChildTests
    {
        ...
        private readonly Child _testChild = new()
        {
            ...
            Composition = "<P><I><B>Капли глазные </B></I>в виде прозрачного раствора " +
                          "светло-желтого цвета.</P>\n<TABLE width=\"100%\" border=\"1\">\n<TR>" +
                          "\n<TD></TD>\n<TD><B>1 мл</B></TD></TR>\n<TR>\n<TD>офлоксацин</TD>\n" +
                          "<TD>3 мг</TD></TR></TABLE>\n<P><i class=\"pring\">Вспомогательные " +
                          "вещества</i>: бензалкония хлорид - 0.025 мг, натрия хлорид - 9 мг, " +
                          "хлористоводородной кислоты 1М раствор - 4.5-5.5 мг, натрия гидроксида " +
                          "1М раствор - 2.5-3.5 мг, вода д/и - до 1 мл.</P>\n<P>5 мл - флаконы " +
                          "полиэтиленовые (1) с капельницей - пачки картонные.</P>",
            Companies =
            [
                new CompanyDetailed
                {
