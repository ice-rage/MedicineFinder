...
namespace MedicineFinder.Server.Testing.ModelTests
{
    ...
    /// <see cref="MedicineInfo"/>.
    /// </summary>
    public class MedicineInfoTests
    {
        private readonly MedicineInfo _testMedicineInfo =
            CreateTestMedicineInfo();

        [TestCase(TestName = "Позитивный тест геттера Products")]
        public void TestMedicineInfoGet_ReturnsSameValue()
        {
            // Arrange
            var expectedMedicineInfo = new MedicineInfo
            {
                Products =
                [
                    new Product()
            ...
            var expected = expectedMedicineInfo.Products;
        ...
        {
            // Arrange
            var expected = _testMedicineInfo.Products;

            // Act
            _testMedicineInfo.Products = expected;
            var actual = _testMedicineInfo.Products;
        ...
        private static MedicineInfo CreateTestMedicineInfo()
        {
