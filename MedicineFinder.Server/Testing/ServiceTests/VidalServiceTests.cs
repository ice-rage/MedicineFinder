...
namespace MedicineFinder.Server.Testing.ServiceTests
{
    /// <summary>
    /// Класс, содержащий модульные тесты для класса
    /// <see cref="VidalService"/>.
    /// </summary>
    [TestFixture]
    public class VidalServiceTests
    {
        /// <summary>
        ...
        private readonly VidalService _testVidalService = new(
            new HttpClient
            {
                ...
                {
                    {
                        AccessTokenName, TestConfiguration[AccessTokenName]
                    }
                }
            });
